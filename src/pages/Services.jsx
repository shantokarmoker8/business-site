...
const services = [
  {
    ...
    img: "https://images.unsplash.com/photo-1547658719-da2b51169166?w=400&h=250&fit=crop",
  },
  {
    icon: RiPaletteLine,
    title: "UI/UX Design",
  ...
  },
  {
    ...
    img: "https://images.unsplash.com/photo-1432888622747-4eb9a8efeb07?w=400&h=250&fit=crop",
  },
  {
    ...
    <div className="bg-white rounded-2xl overflow-hidden border border-green-100 hover:shadow-xl hover:shadow-green-50 transition-all duration-300 group">
      ...
      <div className="p-7">
        ...
        <ul className="space-y-2">
          {props.features.map(function (feat) {
            return (
              <li
                key={feat}
...
export default function Services() {
  return (
    <div>
      ...
      <section className="bg-white py-24 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            {["Discovery", "Planning", "Execution", "Launch"].map(
              function (step, i) {
                return (
                  <div key={step} className="text-center">
                    <div
                      className="w-14 h-14 bg-green-500 text-white rounded-2xl flex items-center justify-center text-xl font-black mx-auto mb-4"
                      style={{ fontFamily: "'Playfair Display', serif" }}
                    >
                      {i + 1}
                    </div>
                    <div className="font-bold text-gray-900 mb-2">{step}</div>
      ...
      {/* CTA */}
      <section className="bg-green-500 py-20 px-6 text-center">
        <h2
          style={{ fontFamily: "'Playfair Display', serif" }}
